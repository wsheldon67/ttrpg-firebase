...
export function results(label:string):[string, string, string, string] {
  switch (label) {
    case 'Intimidate - Fueled by Anger':
    case 'Intimidate':
      return [
        `There are no specific consquecnes for basic moves.`, `<p>They choose 1:</p>`, `<p>You eliminate 1, then they choose 1 of the remaining options:</p>`,
        `<ul>
